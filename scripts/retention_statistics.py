...
if dataread:
    ...
    #Original: Sheet6;      square root-transformed: Sheet9
    df=pd.read_excel(datafile, sheet_name='Sheet6',
                     header=0)
    ...
    vfcc_1 = df['vwc10kPa'][0:7]
    vfcc_2 = df['vwc10kPa'][7:14]
    vfcc_3 = df['vwc10kPa'][14:21]
...
if anova:
    ...
    if True:
        ...
        st_vfcc = ols('vwc10kPa ~ C(Depth)', data=df).fit()
        print('-------- vwc10kPa ----------')
