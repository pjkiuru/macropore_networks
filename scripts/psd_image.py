...
if joint:
    ...
    sppos = [
            [0.14, 0.61, spdim_2[0],spdim_2[1]],
            [0.55, 0.61, spdim_2[0],spdim_2[1]],
            [0.01, 0.01, spdim_2[0],spdim_2[1]],
            [0.08, 0.11, spdim[0],spdim[1]],
            [0.40, 0.11, spdim[0],spdim[1]],
            [0.72, 0.11, spdim[0],spdim[1]],
            [0.08, 0.06, spdim[0],spdim[1]],
            [0.40, 0.06, spdim[0],spdim[1]],
            [0.72, 0.06, spdim[0],spdim[1]],
            ]
    ...
    #ax1.hist(diam_3_1[int_3_1], histtype='step', bins=100, density=True,  color = 'r', label='1')
    bins =  np.logspace(np.log10(np.min(diam_1_all)), np.log10(np.max(diam_1_all)), num=40)
    ax1.hist(diam_1_all, histtype='step', bins=bins, density=True,  color = colors_3[0], label='0\u20135 cm')
    bins =  np.logspace(np.log10(np.min(diam_2_all)), np.log10(np.max(diam_2_all)), num=40)
    ax1.hist(diam_2_all, histtype='step', bins=bins, density=True,  color = colors_3[1], label='20\u201325 cm')
    bins =  np.logspace(np.log10(np.min(diam_3_all)), np.log10(np.max(diam_3_all)), num=40)
    ax1.hist(diam_3_all, histtype='step', bins=bins, density=True,  color = colors_3[2], label='40\u201345 cm')
    ...
    ax5.legend(fontsize=fontsize, ncol=2, columnspacing=0.7,#borderaxespad=1.0,
               handlelength=0.6, loc='upper left', bbox_to_anchor=(0.05, 0.85))
    ...
    ax4.xaxis.set_label_coords(0.5, -0.16)
    ax5.xaxis.set_label_coords(0.5, -0.16)
    ax6.xaxis.set_label_coords(0.5, -0.16)
